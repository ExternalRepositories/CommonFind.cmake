...
#             message(FATAL_ERROR "${__FUNCTION__}: argument VERSION_REGEXPES is not set")
        elseif(PARSED_ARGS_VERSION_REGEXPES_LENGTH EQUAL 1)
            ...
            if(EXISTS "${${PARSED_ARGS_OUTPUT_VARIABLE_NAME}_INCLUDE_DIR}/${PARSED_ARGS_HEADER}")
            ...
            endif(EXISTS "${${PARSED_ARGS_OUTPUT_VARIABLE_NAME}_INCLUDE_DIR}/${PARSED_ARGS_HEADER}")
        endif()
